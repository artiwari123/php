...
$sqltab="SELECT * FROM `mom_bio` where email_id='$emailId'";
	  ...
	  ?>
        ...
        <section id="about-us" class="page-section " style="margin-bottom:-50px">
            ...
            <div class="row">
             ...
             <h2 class="title">
                       <center> <b>
                            <font color="#eb008b">Mom Details</font>
                        </b></center>
                    </h2>
...
unset($_SESSION['er']);  
  ...
  <button class="tablinks" onclick="openCity(event, 'WithDad')" >With Dad</button>
  <button class="tablinks" onclick="openCity(event, 'PhotoUpload')">Photo Upload</button>
  <button class="tablinks" onclick="openCity(event, 'MomLifeinherwords')">Mom Life in her words</button>
  <button class="tablinks" onclick="openCity(event, 'Friends')">Friends</button>
  <button class="tablinks" onclick="openCity(event, 'Feelingsforher')">Feelings for her</button>
  <button class="tablinks" onclick="window.open('mombio','_blank');" >View Biography</button>
</div>
...
<div id="Personal" class="tabcontent">
 <form method="post"  class="form-box register-form contact-form no-margin" id="forma" name="motors" action="mombio_submit.php" enctype="multipart/form-data">
  ...
  <center><h3>Personal Details</h3></center>
					   ...
					   <div class="col-sm-6">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <input type="text" class="form-control" name="before_marriage_name" placeholder="Before Marriage Full Name" value="<?php echo $before_marriage_name;?>">
                                                        </div>
                                                    </div>
                                                    <!-- check in -->
                                                    <div class="col-sm-3">
 ...
 ?>
                                                    ...
                                                    <div class="col-sm-12">
														...
														<div class="col-sm-4">
																	...
																	<?php
																	$sqltab="SELECT id FROM `mompicture` where emailid='$emailId' AND category = 'SCHOOLING'";
																	$asdfg=mysql_query($sqltab) ;
																		$num2 = mysql_num_rows($asdfg);
																		if($num2 != 0)
																		{

																	echo '<a href="mombio/index.php?contacttab=#SCHOOLING" class="btn btn-primary  active"  target="_blank" role="button" aria-pressed="true">VIEW PHOTO</a>
';
 ...
 ?>
                                                    ...
                                                    <div class="col-sm-12">
														...
														<div class="col-sm-4">
																	...
																	<?php
																	$sqltab="SELECT id FROM `mompicture` where emailid='$emailId' AND category = 'COLLEGE'";
																	$asdfg=mysql_query($sqltab) ;
																		$num2 = mysql_num_rows($asdfg);
																		if($num2 != 0)
																		{

																	echo '<a href="mombio/index.php?contacttab=#COLLEGE" class="btn btn-primary  active" role="button"  target="_blank"  aria-pressed="true">VIEW PHOTO</a>
';
 ...
 ?>
                                                    ...
                                                    <div class="col-sm-12">
														...
														<div class="col-sm-4">
																	...
																	<?php
																	$sqltab="SELECT id FROM `mompicture` where emailid='$emailId' AND category = 'HOSTEL'";
																	$asdfg=mysql_query($sqltab) ;
																		$num2 = mysql_num_rows($asdfg);
																		if($num2 != 0)
																		{

																	echo '<a href="mombio/index.php?contacttab=#HOSTEL" class="btn btn-primary  active" target="_blank"  role="button" aria-pressed="true">VIEW PHOTO</a>
';
...
<div id="Professional" class="tabcontent">
  <center><h3>Mom Professional Journey</h3></center>
                        <div class="row">
                            <div class="col-md-12">
                                <div role="tabpanel" class="travel-tab">
                                    <!-- Nav tabs -->
 ...
 ?>
                                                    ...
                                                    <div class="col-sm-12">
														...
														<div class="col-sm-4">
																	...
																	<?php
																	$sqltab="SELECT id FROM `mompicture` where emailid='$emailId' AND category = 'FIRSTJOB'";
																	$asdfg=mysql_query($sqltab) ;
																		$num2 = mysql_num_rows($asdfg);
																		if($num2 != 0)
																		{

																	echo '<a href="mombio/index.php?contacttab=#FIRSTJOB" class="btn btn-primary  active"  target="_blank" role="button" aria-pressed="true">VIEW PHOTO</a>
';
 ...
 ?>
                                                    ...
                                                    <div class="col-sm-12">
														...
														<div class="col-sm-4">
																	...
																	<?php
																	$sqltab="SELECT id FROM `mompicture` where emailid='$emailId' AND category = 'LASTJOB'";
																	$asdfg=mysql_query($sqltab) ;
																		$num2 = mysql_num_rows($asdfg);
																		if($num2 != 0)
																		{

																	echo '<a href="mombio/index.php?contacttab=#LASTJOB" class="btn btn-primary  active" target="_blank" role="button" aria-pressed="true">VIEW PHOTO</a>
';
...
<div id="WithDad" class="tabcontent">
  <center><h3>Mom Journey with Dad</h3></center>
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="col-sm-12">
														...
														<div class="col-sm-4">
																	...
																	<?php
																	$sqltab="SELECT id FROM `mompicture` where emailid='$emailId' AND category = 'CHILDHOOD'";
																	$asdfg=mysql_query($sqltab) ;
																		$num2 = mysql_num_rows($asdfg);
																		if($num2 != 0)
																		{

																	echo '<a href="mombio/index.php?contacttab=#CHILDHOOD" class="btn btn-primary  active" target="_blank" role="button" aria-pressed="true">VIEW PHOTO</a>
';
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="col-sm-12">
														...
														<div class="col-sm-4">
																	...
																	<?php
																	$sqltab="SELECT id FROM `mompicture` where emailid='$emailId' AND category = 'TEENAGE'";
																	$asdfg=mysql_query($sqltab) ;
																		$num2 = mysql_num_rows($asdfg);
																		if($num2 != 0)
																		{

																	echo '<a href="mombio/index.php?contacttab=#TEENAGE" class="btn btn-primary  active" target="_blank" role="button" aria-pressed="true">VIEW PHOTO</a>
';
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="col-sm-12">
														...
														<div class="col-sm-4">
																	...
																	<?php
																	$sqltab="SELECT id FROM `mompicture` where emailid='$emailId' AND category = 'YOUNGAGE'";
																	$asdfg=mysql_query($sqltab) ;
																		$num2 = mysql_num_rows($asdfg);
																		if($num2 != 0)
																		{

																	echo '<a href="mombio/index.php?contacttab=#YOUNGAGE" class="btn btn-primary  active" target="_blank" role="button" aria-pressed="true">VIEW PHOTO</a>
';
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="col-sm-12">
														...
														<div class="col-sm-4">
																	...
																	<?php
																	$sqltab="SELECT id FROM `mompicture` where emailid='$emailId' AND category = 'MARRIAGE'";
																	$asdfg=mysql_query($sqltab) ;
																		$num2 = mysql_num_rows($asdfg);
																		if($num2 != 0)
																		{

																	echo '<a href="mombio/index.php?contacttab=#MARRIAGE" class="btn btn-primary  active" target="_blank" role="button" aria-pressed="true">VIEW PHOTO</a>
';
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="col-sm-12">
														...
														<div class="col-sm-4">
																	...
																	<?php
																	$sqltab="SELECT id FROM `mompicture` where emailid='$emailId' AND category = 'HONEYMOON'";
																	$asdfg=mysql_query($sqltab) ;
																		$num2 = mysql_num_rows($asdfg);
																		if($num2 != 0)
																		{

																	echo '<a href="mombio/index.php?contacttab=#HONEYMOON" class="btn btn-primary  active" target="_blank" role="button" aria-pressed="true">VIEW PHOTO</a>
';
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div role="tabpanel" class="tab-pane active" id="hotels">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12">1st Pregnancy</div>
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="col-sm-8">
                                                                <div class="form-group"><br>
                                                                    <input type="file" name="files14[]" class='form-control' multiple>
														...
														<div class="col-sm-4">
																	...
																	<?php
																	$sqltab="SELECT id FROM `mompicture` where emailid='$emailId' AND category = 'FIRSTPREGANCY'";
																	$asdfg=mysql_query($sqltab) ;
																		$num2 = mysql_num_rows($asdfg);
																		if($num2 != 0)
																		{

																	echo '<a href="mombio/index.php?contacttab=#FIRSTPREGANCY" class="btn btn-primary  active" target="_blank" role="button" aria-pressed="true">VIEW PHOTO</a>
';
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div role="tabpanel" class="tab-pane active" id="hotels">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12">2nd Pregnancy</div>
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="col-sm-8">
                                                                <div class="form-group"><br>
                                                                    <input type="file" name="files15[]" class='form-control' multiple>
														...
														<div class="col-sm-4">
																	...
																	<?php
																	$sqltab="SELECT id FROM `mompicture` where emailid='$emailId' AND category = 'SECONDPREGANCY'";
																	$asdfg=mysql_query($sqltab) ;
																		$num2 = mysql_num_rows($asdfg);
																		if($num2 != 0)
																		{

																	echo '<a href="mombio/index.php?contacttab=#SECONDPREGANCY" class="btn btn-primary  active" target="_blank" role="button" aria-pressed="true">VIEW PHOTO</a>
';
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div role="tabpanel" class="tab-pane active" id="hotels">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12">3rd Pregnancy</div>
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="col-sm-8">
                                                                <div class="form-group"><br>
                                                                    <input type="file" name="files16[]" class='form-control' multiple>
														...
														<div class="col-sm-4">
																	...
																	<?php
																	$sqltab="SELECT id FROM `mompicture` where emailid='$emailId' AND category = 'THIRDPREGANCY'";
																	$asdfg=mysql_query($sqltab) ;
																		$num2 = mysql_num_rows($asdfg);
																		if($num2 != 0)
																		{

																	echo '<a href="mombio/index.php?contacttab=#THIRDPREGANCY" class="btn btn-primary  active" target="_blank" role="button" aria-pressed="true">VIEW PHOTO</a>
';
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div role="tabpanel" class="tab-pane active" id="hotels">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12">4th Pregnancy</div>
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="col-sm-8">
                                                                <div class="form-group"><br>
                                                                    <input type="file" name="files19[]" class='form-control' multiple>
														...
														<div class="col-sm-4">
																	...
																	<?php
																	$sqltab="SELECT id FROM `mompicture` where emailid='$emailId' AND category = 'FOURTHPREGANCY'";
																	$asdfg=mysql_query($sqltab) ;
																		$num2 = mysql_num_rows($asdfg);
																		if($num2 != 0)
																		{

																	echo '<a href="mombio/index.php?contacttab=#FOURTHPREGANCY" class="btn btn-primary  active" target="_blank" role="button" aria-pressed="true">VIEW PHOTO</a>
';
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="col-sm-12">
														...
														<div class="col-sm-4">
																	...
																	<?php
																	$sqltab="SELECT id FROM `mompicture` where emailid='$emailId' AND category = 'FAMILY'";
																	$asdfg=mysql_query($sqltab) ;
																		$num2 = mysql_num_rows($asdfg);
																		if($num2 != 0)
																		{

																	echo '<a href="mombio/index.php?contacttab=#FAMILY" class="btn btn-primary  active" target="_blank" role="button" aria-pressed="true">VIEW PHOTO</a>
';
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="col-sm-12">
														...
														<div class="col-sm-4">
																	...
																	<?php
																	$sqltab="SELECT id FROM `mompicture` where emailid='$emailId' AND category = 'CURRENTAGE'";
																	$asdfg=mysql_query($sqltab) ;
																		$num2 = mysql_num_rows($asdfg);
																		if($num2 != 0)
																		{

																	echo '<a href="mombio/index.php?contacttab=#CURRENTAGE" class="btn btn-primary  active" target="_blank" role="button" aria-pressed="true">VIEW PHOTO</a>
';
...
<div id="MomLifeinherwords" class="tabcontent">
  <center><h3>Mom life in her own words</h3></center>
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div role="tabpanel" class="tab-pane active" id="hotels">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12">Her feelings for Dad</div>
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div role="tabpanel" class="tab-pane active" id="hotels">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12">Her feelings for you</div>
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div role="tabpanel" class="tab-pane active" id="hotels">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12">Her feelings for your sibling</div>
...
<div id="Friends" class="tabcontent">
 <center> <h3>Mom best friends</h3></center>
 ...
 ?>
                                                    ...
                                                    <div class="col-sm-12">
														...
														<div class="col-sm-4">
																	...
																	<?php
																	$sqltab="SELECT id FROM `mompicture` where emailid='$emailId'  AND category = 'BESTFRIEND' AND frid= '1'";							$asdfg=mysql_query($sqltab) ;
																		$num2 = mysql_num_rows($asdfg);
																		if($num2 != 0)
																		{

																	echo '<a href="mombio/index.php?contacttab=#BESTFRIEND1" class="btn btn-primary  active" target="_blank" role="button" aria-pressed="true">VIEW PHOTO</a>
';
 ...
 ?>
                                                    ...
                                                    <div class="col-sm-12">
														...
														<div class="col-sm-4">
																	...
																	<?php
																	$sqltab="SELECT id FROM `mompicture` where emailid='$emailId'  AND category = 'BESTFRIEND' AND frid= '2'";							$asdfg=mysql_query($sqltab) ;
																		$num2 = mysql_num_rows($asdfg);
																		if($num2 != 0)
																		{

																	echo '<a href="mombio/index.php?contacttab=#BESTFRIEND2" class="btn btn-primary  active" target="_blank" role="button" aria-pressed="true">VIEW PHOTO</a>
';
 ...
 ?>
                                                    ...
                                                    <div class="col-sm-12">
														...
														<div class="col-sm-4">
																	...
																	<?php
																	$sqltab="SELECT id FROM `mompicture` where emailid='$emailId'  AND category = 'BESTFRIEND' AND frid= '3'";							$asdfg=mysql_query($sqltab) ;
																		$num2 = mysql_num_rows($asdfg);
																		if($num2 != 0)
																		{

																	echo '<a href="mombio/index.php?contacttab=#BESTFRIEND3" class="btn btn-primary  active" target="_blank" role="button" aria-pressed="true">VIEW PHOTO</a>
';
 ...
 ?>
                                                    ...
                                                    <div class="col-sm-12">
														...
														<div class="col-sm-4">
																	...
																	<?php
																	$sqltab="SELECT id FROM `mompicture` where emailid='$emailId'  AND category = 'BESTFRIEND' AND frid= '4'";							$asdfg=mysql_query($sqltab) ;
																		$num2 = mysql_num_rows($asdfg);
																		if($num2 != 0)
																		{

																	echo '<a href="mombio/index.php?contacttab=#BESTFRIEND4" class="btn btn-primary  active" target="_blank" role="button" aria-pressed="true">VIEW PHOTO</a>
';
 ...
 ?>
                                                    ...
                                                    <div class="col-sm-12">
														...
														<div class="col-sm-4">
																	...
																	<?php
																	$sqltab="SELECT id FROM `mompicture` where emailid='$emailId'  AND category = 'BESTFRIEND' AND frid= '5'";							$asdfg=mysql_query($sqltab) ;
																		$num2 = mysql_num_rows($asdfg);
																		if($num2 != 0)
																		{

																	echo '<a href="mombio/index.php?contacttab=#BESTFRIEND5" class="btn btn-primary  active" target="_blank" role="button" aria-pressed="true">VIEW PHOTO</a>
';
...
<div id="Feelingsforher" class="tabcontent">
  <center><h3>Your feeling for her</h3></center>
                           <br />
                           <div class="row">
                            <div class="col-md-12">
                                <div role="tabpanel" class="travel-tab">
